...
public class RequestTypeSchemaActionHandler extends AbstractActionHandler<RequestTypeSchemaAction> {
    ...
    @Override
    protected List<Action> executeAction(RequestTypeSchemaAction action) {
        ...
        URI uri = URI.createFileURI(
            "/home/ipa-hsd/projects/kogrob2/urdf/glsp_tests/my_glsp_test/kinematics-glsp/glsp-server/model/LinkModel.json");
