   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case GraphPackage.GMODEL_ELEMENT: {
            ...
            if (result == null) result = caseGArgumentable(gModelElement);
         ...
         case GraphPackage.GSHAPE_ELEMENT: {
            ...
            if (result == null) result = caseGModelElement(gShapeElement);
            if (result == null) result = caseGBoundsAware(gShapeElement);
            if (result == null) result = caseGArgumentable(gShapeElement);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case GraphPackage.GGRAPH: {
            ...
            if (result == null) result = caseGModelRoot(gGraph);
            if (result == null) result = caseGBoundsAware(gGraph);
            if (result == null) result = caseGModelElement(gGraph);
            if (result == null) result = caseGArgumentable(gGraph);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case GraphPackage.GMODEL_ROOT: {
            ...
            if (result == null) result = caseGModelElement(gModelRoot);
            if (result == null) result = caseGArgumentable(gModelRoot);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case GraphPackage.GNODE: {
            ...
            if (result == null) result = caseGShapeElement(gNode);
            if (result == null) result = caseGEdgeLayoutable(gNode);
            if (result == null) result = caseGLayouting(gNode);
            if (result == null) result = caseGModelElement(gNode);
            if (result == null) result = caseGBoundsAware(gNode);
            if (result == null) result = caseGArgumentable(gNode);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case GraphPackage.GEDGE: {
            ...
            if (result == null) result = caseGModelElement(gEdge);
            if (result == null) result = caseGArgumentable(gEdge);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case GraphPackage.GCOMPARTMENT: {
            ...
            if (result == null) result = caseGShapeElement(gCompartment);
            if (result == null) result = caseGLayouting(gCompartment);
            if (result == null) result = caseGModelElement(gCompartment);
            if (result == null) result = caseGBoundsAware(gCompartment);
            if (result == null) result = caseGArgumentable(gCompartment);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case GraphPackage.GLABEL: {
            ...
            if (result == null) result = caseGAlignable(gLabel);
            if (result == null) result = caseGEdgeLayoutable(gLabel);
            if (result == null) result = caseGShapeElement(gLabel);
            if (result == null) result = caseGModelElement(gLabel);
            if (result == null) result = caseGBoundsAware(gLabel);
            if (result == null) result = caseGArgumentable(gLabel);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case GraphPackage.GISSUE_MARKER: {
            ...
            if (result == null) result = caseGShapeElement(gIssueMarker);
            if (result == null) result = caseGModelElement(gIssueMarker);
            if (result == null) result = caseGBoundsAware(gIssueMarker);
            if (result == null) result = caseGArgumentable(gIssueMarker);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case GraphPackage.GPORT: {
            ...
            if (result == null) result = caseGShapeElement(gPort);
            if (result == null) result = caseGModelElement(gPort);
            if (result == null) result = caseGBoundsAware(gPort);
            if (result == null) result = caseGArgumentable(gPort);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case GraphPackage.GBUTTON: {
            ...
            if (result == null) result = caseGShapeElement(gButton);
            if (result == null) result = caseGModelElement(gButton);
            if (result == null) result = caseGBoundsAware(gButton);
            if (result == null) result = caseGArgumentable(gButton);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         ...
         case GraphPackage.GHTML_ROOT: {
            ...
            if (result == null) result = caseGModelRoot(gHtmlRoot);
            if (result == null) result = caseGModelElement(gHtmlRoot);
            if (result == null) result = caseGArgumentable(gHtmlRoot);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case GraphPackage.GPRE_RENDERED_ELEMENT: {
            ...
            if (result == null) result = caseGModelElement(gPreRenderedElement);
            if (result == null) result = caseGArgumentable(gPreRenderedElement);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
