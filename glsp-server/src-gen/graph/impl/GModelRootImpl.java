 ...
 * </p>
 * <ul>
 *   <li>{@link graph.impl.GModelRootImpl#getId <em>Id</em>}</li>
 *   <li>{@link graph.impl.GModelRootImpl#getCssClasses <em>Css Classes</em>}</li>
 *   <li>{@link graph.impl.GModelRootImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link graph.impl.GModelRootImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link graph.impl.GModelRootImpl#getTrace <em>Trace</em>}</li>
 *   <li>{@link graph.impl.GModelRootImpl#getType <em>Type</em>}</li>
 *   <li>{@link graph.impl.GModelRootImpl#getCanvasBounds <em>Canvas Bounds</em>}</li>
 *   <li>{@link graph.impl.GModelRootImpl#getRevision <em>Revision</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GModelRootImpl extends GArgumentableImpl implements GModelRoot {
   ...
   public EList<GModelElement> getChildren() {
      if (children == null) {
         children = new EObjectContainmentWithInverseEList<GModelElement>(GModelElement.class, this, GraphPackage.GMODEL_ROOT__CHILDREN, GraphPackage.GMODEL_ELEMENT__PARENT);
      }
      return children;
   }
   ...
   public GModelElement getParent() {
      if (eContainerFeatureID() != GraphPackage.GMODEL_ROOT__PARENT) return null;
   ...
   public void setParent(GModelElement newParent) {
      if (newParent != eInternalContainer() || (eContainerFeatureID() != GraphPackage.GMODEL_ROOT__PARENT && newParent != null)) {
   ...
   public NotificationChain basicSetCanvasBounds(GBounds newCanvasBounds, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GraphPackage.GMODEL_ROOT__CANVAS_BOUNDS, oldCanvasBounds, newCanvasBounds);
   ...
   public void setCanvasBounds(GBounds newCanvasBounds) {
      if (newCanvasBounds != canvasBounds) {
         ...
         if (canvasBounds != null)
            msgs = ((InternalEObject)canvasBounds).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GMODEL_ROOT__CANVAS_BOUNDS, null, msgs);
         if (newCanvasBounds != null)
            msgs = ((InternalEObject)newCanvasBounds).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GMODEL_ROOT__CANVAS_BOUNDS, null, msgs);
         msgs = basicSetCanvasBounds(newCanvasBounds, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GMODEL_ROOT__CANVAS_BOUNDS, newCanvasBounds, newCanvasBounds));
   }
   ...
   public void setRevision(int newRevision) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GMODEL_ROOT__REVISION, oldRevision, revision));
   }
