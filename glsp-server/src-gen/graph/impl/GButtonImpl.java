 ...
 * </p>
 * <ul>
 *   <li>{@link graph.impl.GButtonImpl#getId <em>Id</em>}</li>
 *   <li>{@link graph.impl.GButtonImpl#getCssClasses <em>Css Classes</em>}</li>
 *   <li>{@link graph.impl.GButtonImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link graph.impl.GButtonImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link graph.impl.GButtonImpl#getTrace <em>Trace</em>}</li>
 *   <li>{@link graph.impl.GButtonImpl#getType <em>Type</em>}</li>
 *   <li>{@link graph.impl.GButtonImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link graph.impl.GButtonImpl#getSize <em>Size</em>}</li>
 *   <li>{@link graph.impl.GButtonImpl#isEnabled <em>Enabled</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GButtonImpl extends GArgumentableImpl implements GButton {
   ...
   public EList<GModelElement> getChildren() {
      if (children == null) {
         children = new EObjectContainmentWithInverseEList<GModelElement>(GModelElement.class, this, GraphPackage.GBUTTON__CHILDREN, GraphPackage.GMODEL_ELEMENT__PARENT);
      }
      return children;
   }
   ...
   public GModelElement getParent() {
      if (eContainerFeatureID() != GraphPackage.GBUTTON__PARENT) return null;
   ...
   public void setParent(GModelElement newParent) {
      if (newParent != eInternalContainer() || (eContainerFeatureID() != GraphPackage.GBUTTON__PARENT && newParent != null)) {
   ...
   public NotificationChain basicSetPosition(GPoint newPosition, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GraphPackage.GBUTTON__POSITION, oldPosition, newPosition);
   ...
   public void setPosition(GPoint newPosition) {
      if (newPosition != position) {
         NotificationChain msgs = null;
         if (position != null)
            msgs = ((InternalEObject)position).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GBUTTON__POSITION, null, msgs);
         if (newPosition != null)
            msgs = ((InternalEObject)newPosition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GBUTTON__POSITION, null, msgs);
         msgs = basicSetPosition(newPosition, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GBUTTON__POSITION, newPosition, newPosition));
   }
   ...
   public NotificationChain basicSetSize(GDimension newSize, NotificationChain msgs) {
      ...
      size = newSize;
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GraphPackage.GBUTTON__SIZE, oldSize, newSize);
         if (msgs == null) msgs = notification; else msgs.add(notification);
      }
      return msgs;
   }
   ...
   public void setSize(GDimension newSize) {
      if (newSize != size) {
         NotificationChain msgs = null;
         if (size != null)
            msgs = ((InternalEObject)size).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GBUTTON__SIZE, null, msgs);
         if (newSize != null)
            msgs = ((InternalEObject)newSize).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GBUTTON__SIZE, null, msgs);
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
      if (baseClass == GBoundsAware.class) {
         switch (derivedFeatureID) {
            case GraphPackage.GBUTTON__POSITION: return GraphPackage.GBOUNDS_AWARE__POSITION;
            case GraphPackage.GBUTTON__SIZE: return GraphPackage.GBOUNDS_AWARE__SIZE;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
      if (baseClass == GBoundsAware.class) {
         switch (baseFeatureID) {
            case GraphPackage.GBOUNDS_AWARE__POSITION: return GraphPackage.GBUTTON__POSITION;
            case GraphPackage.GBOUNDS_AWARE__SIZE: return GraphPackage.GBUTTON__SIZE;
            default: return -1;
         }
      }
