 ...
 * </p>
 * <ul>
 *   <li>{@link graph.impl.GNodeImpl#getId <em>Id</em>}</li>
 *   <li>{@link graph.impl.GNodeImpl#getCssClasses <em>Css Classes</em>}</li>
 *   <li>{@link graph.impl.GNodeImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link graph.impl.GNodeImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link graph.impl.GNodeImpl#getTrace <em>Trace</em>}</li>
 *   <li>{@link graph.impl.GNodeImpl#getType <em>Type</em>}</li>
 *   <li>{@link graph.impl.GNodeImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link graph.impl.GNodeImpl#getSize <em>Size</em>}</li>
 *   <li>{@link graph.impl.GNodeImpl#getEdgePlacement <em>Edge Placement</em>}</li>
 *   <li>{@link graph.impl.GNodeImpl#getLayout <em>Layout</em>}</li>
 *   <li>{@link graph.impl.GNodeImpl#getLayoutOptions <em>Layout Options</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GNodeImpl extends GArgumentableImpl implements GNode {
   ...
   public EList<GModelElement> getChildren() {
      if (children == null) {
         children = new EObjectContainmentWithInverseEList<GModelElement>(GModelElement.class, this, GraphPackage.GNODE__CHILDREN, GraphPackage.GMODEL_ELEMENT__PARENT);
      }
      return children;
   }
   ...
   public GModelElement getParent() {
      if (eContainerFeatureID() != GraphPackage.GNODE__PARENT) return null;
   ...
   public void setParent(GModelElement newParent) {
      if (newParent != eInternalContainer() || (eContainerFeatureID() != GraphPackage.GNODE__PARENT && newParent != null)) {
   ...
   public NotificationChain basicSetPosition(GPoint newPosition, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GraphPackage.GNODE__POSITION, oldPosition, newPosition);
   ...
   public void setPosition(GPoint newPosition) {
      if (newPosition != position) {
         NotificationChain msgs = null;
         if (position != null)
            msgs = ((InternalEObject)position).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GNODE__POSITION, null, msgs);
         if (newPosition != null)
            msgs = ((InternalEObject)newPosition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GNODE__POSITION, null, msgs);
   ...
   public NotificationChain basicSetSize(GDimension newSize, NotificationChain msgs) {
      ...
      size = newSize;
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GraphPackage.GNODE__SIZE, oldSize, newSize);
         if (msgs == null) msgs = notification; else msgs.add(notification);
      }
      return msgs;
   }
   ...
   public void setSize(GDimension newSize) {
      if (newSize != size) {
         NotificationChain msgs = null;
         if (size != null)
            msgs = ((InternalEObject)size).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GNODE__SIZE, null, msgs);
         if (newSize != null)
            msgs = ((InternalEObject)newSize).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GNODE__SIZE, null, msgs);
   ...
   public NotificationChain basicSetEdgePlacement(GEdgePlacement newEdgePlacement, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GraphPackage.GNODE__EDGE_PLACEMENT, oldEdgePlacement, newEdgePlacement);
         if (msgs == null) msgs = notification; else msgs.add(notification);
      }
      return msgs;
   }
   ...
   public void setEdgePlacement(GEdgePlacement newEdgePlacement) {
      if (newEdgePlacement != edgePlacement) {
         ...
         if (edgePlacement != null)
            msgs = ((InternalEObject)edgePlacement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GNODE__EDGE_PLACEMENT, null, msgs);
         if (newEdgePlacement != null)
            msgs = ((InternalEObject)newEdgePlacement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GNODE__EDGE_PLACEMENT, null, msgs);
         msgs = basicSetEdgePlacement(newEdgePlacement, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GNODE__EDGE_PLACEMENT, newEdgePlacement, newEdgePlacement));
   }
   ...
   public EMap<String, Object> getLayoutOptions() {
      if (layoutOptions == null) {
         layoutOptions = new EcoreEMap<String,Object>(GraphPackage.Literals.STRING_TO_OBJECT_MAP_ENTRY, StringToObjectMapEntryImpl.class, this, GraphPackage.GNODE__LAYOUT_OPTIONS);
      }
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
      if (baseClass == GBoundsAware.class) {
         switch (derivedFeatureID) {
            case GraphPackage.GNODE__POSITION: return GraphPackage.GBOUNDS_AWARE__POSITION;
            case GraphPackage.GNODE__SIZE: return GraphPackage.GBOUNDS_AWARE__SIZE;
            default: return -1;
         }
      }
      if (baseClass == GEdgeLayoutable.class) {
         switch (derivedFeatureID) {
            case GraphPackage.GNODE__EDGE_PLACEMENT: return GraphPackage.GEDGE_LAYOUTABLE__EDGE_PLACEMENT;
            default: return -1;
         }
      }
      if (baseClass == GLayouting.class) {
         switch (derivedFeatureID) {
            case GraphPackage.GNODE__LAYOUT: return GraphPackage.GLAYOUTING__LAYOUT;
            case GraphPackage.GNODE__LAYOUT_OPTIONS: return GraphPackage.GLAYOUTING__LAYOUT_OPTIONS;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
      if (baseClass == GBoundsAware.class) {
         switch (baseFeatureID) {
            case GraphPackage.GBOUNDS_AWARE__POSITION: return GraphPackage.GNODE__POSITION;
            case GraphPackage.GBOUNDS_AWARE__SIZE: return GraphPackage.GNODE__SIZE;
            default: return -1;
         }
      }
      if (baseClass == GEdgeLayoutable.class) {
         switch (baseFeatureID) {
            case GraphPackage.GEDGE_LAYOUTABLE__EDGE_PLACEMENT: return GraphPackage.GNODE__EDGE_PLACEMENT;
            default: return -1;
         }
      }
      if (baseClass == GLayouting.class) {
         switch (baseFeatureID) {
            case GraphPackage.GLAYOUTING__LAYOUT: return GraphPackage.GNODE__LAYOUT;
            case GraphPackage.GLAYOUTING__LAYOUT_OPTIONS: return GraphPackage.GNODE__LAYOUT_OPTIONS;
            default: return -1;
         }
      }
