 ...
 * </p>
 * <ul>
 *   <li>{@link graph.impl.GCompartmentImpl#getId <em>Id</em>}</li>
 *   <li>{@link graph.impl.GCompartmentImpl#getCssClasses <em>Css Classes</em>}</li>
 *   <li>{@link graph.impl.GCompartmentImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link graph.impl.GCompartmentImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link graph.impl.GCompartmentImpl#getTrace <em>Trace</em>}</li>
 *   <li>{@link graph.impl.GCompartmentImpl#getType <em>Type</em>}</li>
 *   <li>{@link graph.impl.GCompartmentImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link graph.impl.GCompartmentImpl#getSize <em>Size</em>}</li>
 *   <li>{@link graph.impl.GCompartmentImpl#getLayout <em>Layout</em>}</li>
 *   <li>{@link graph.impl.GCompartmentImpl#getLayoutOptions <em>Layout Options</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GCompartmentImpl extends GArgumentableImpl implements GCompartment {
   ...
   public EList<GModelElement> getChildren() {
      if (children == null) {
         children = new EObjectContainmentWithInverseEList<GModelElement>(GModelElement.class, this, GraphPackage.GCOMPARTMENT__CHILDREN, GraphPackage.GMODEL_ELEMENT__PARENT);
      }
      return children;
   }
   ...
   public GModelElement getParent() {
      if (eContainerFeatureID() != GraphPackage.GCOMPARTMENT__PARENT) return null;
   ...
   public void setParent(GModelElement newParent) {
      if (newParent != eInternalContainer() || (eContainerFeatureID() != GraphPackage.GCOMPARTMENT__PARENT && newParent != null)) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GCOMPARTMENT__PARENT, newParent, newParent));
   }
   ...
   public NotificationChain basicSetPosition(GPoint newPosition, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GraphPackage.GCOMPARTMENT__POSITION, oldPosition, newPosition);
   ...
   public void setPosition(GPoint newPosition) {
      if (newPosition != position) {
         NotificationChain msgs = null;
         if (position != null)
            msgs = ((InternalEObject)position).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GCOMPARTMENT__POSITION, null, msgs);
         if (newPosition != null)
            msgs = ((InternalEObject)newPosition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GCOMPARTMENT__POSITION, null, msgs);
         msgs = basicSetPosition(newPosition, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GCOMPARTMENT__POSITION, newPosition, newPosition));
   }
   ...
   public NotificationChain basicSetSize(GDimension newSize, NotificationChain msgs) {
      ...
      size = newSize;
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GraphPackage.GCOMPARTMENT__SIZE, oldSize, newSize);
         if (msgs == null) msgs = notification; else msgs.add(notification);
      }
      return msgs;
   }
   ...
   public void setSize(GDimension newSize) {
      if (newSize != size) {
         NotificationChain msgs = null;
         if (size != null)
            msgs = ((InternalEObject)size).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GCOMPARTMENT__SIZE, null, msgs);
         if (newSize != null)
            msgs = ((InternalEObject)newSize).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GCOMPARTMENT__SIZE, null, msgs);
   ...
   public EMap<String, Object> getLayoutOptions() {
      if (layoutOptions == null) {
         layoutOptions = new EcoreEMap<String,Object>(GraphPackage.Literals.STRING_TO_OBJECT_MAP_ENTRY, StringToObjectMapEntryImpl.class, this, GraphPackage.GCOMPARTMENT__LAYOUT_OPTIONS);
      }
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
      if (baseClass == GBoundsAware.class) {
         switch (derivedFeatureID) {
            case GraphPackage.GCOMPARTMENT__POSITION: return GraphPackage.GBOUNDS_AWARE__POSITION;
            case GraphPackage.GCOMPARTMENT__SIZE: return GraphPackage.GBOUNDS_AWARE__SIZE;
            default: return -1;
         }
      }
      if (baseClass == GLayouting.class) {
         switch (derivedFeatureID) {
            case GraphPackage.GCOMPARTMENT__LAYOUT: return GraphPackage.GLAYOUTING__LAYOUT;
            case GraphPackage.GCOMPARTMENT__LAYOUT_OPTIONS: return GraphPackage.GLAYOUTING__LAYOUT_OPTIONS;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
      if (baseClass == GBoundsAware.class) {
         switch (baseFeatureID) {
            case GraphPackage.GBOUNDS_AWARE__POSITION: return GraphPackage.GCOMPARTMENT__POSITION;
            case GraphPackage.GBOUNDS_AWARE__SIZE: return GraphPackage.GCOMPARTMENT__SIZE;
            default: return -1;
         }
      }
      if (baseClass == GLayouting.class) {
         switch (baseFeatureID) {
            case GraphPackage.GLAYOUTING__LAYOUT: return GraphPackage.GCOMPARTMENT__LAYOUT;
            case GraphPackage.GLAYOUTING__LAYOUT_OPTIONS: return GraphPackage.GCOMPARTMENT__LAYOUT_OPTIONS;
            default: return -1;
         }
      }
