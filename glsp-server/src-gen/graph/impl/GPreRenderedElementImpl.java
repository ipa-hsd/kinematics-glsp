 ...
 * </p>
 * <ul>
 *   <li>{@link graph.impl.GPreRenderedElementImpl#getId <em>Id</em>}</li>
 *   <li>{@link graph.impl.GPreRenderedElementImpl#getCssClasses <em>Css Classes</em>}</li>
 *   <li>{@link graph.impl.GPreRenderedElementImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link graph.impl.GPreRenderedElementImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link graph.impl.GPreRenderedElementImpl#getTrace <em>Trace</em>}</li>
 *   <li>{@link graph.impl.GPreRenderedElementImpl#getType <em>Type</em>}</li>
 *   <li>{@link graph.impl.GPreRenderedElementImpl#getCode <em>Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GPreRenderedElementImpl extends GArgumentableImpl implements GPreRenderedElement {
    ...
    * @generated
    */
   protected GPreRenderedElementImpl() {
      super();
   }
   ...
   public EList<String> getCssClasses() {
      if (cssClasses == null) {
         cssClasses = new EDataTypeUniqueEList<String>(String.class, this, GraphPackage.GPRE_RENDERED_ELEMENT__CSS_CLASSES);
      }
      return cssClasses;
   }
   ...
   public EList<GModelElement> getChildren() {
      if (children == null) {
         children = new EObjectContainmentWithInverseEList<GModelElement>(GModelElement.class, this, GraphPackage.GPRE_RENDERED_ELEMENT__CHILDREN, GraphPackage.GMODEL_ELEMENT__PARENT);
      }
      return children;
   }
   ...
   public GModelElement getParent() {
      if (eContainerFeatureID() != GraphPackage.GPRE_RENDERED_ELEMENT__PARENT) return null;
   ...
   public void setParent(GModelElement newParent) {
      if (newParent != eInternalContainer() || (eContainerFeatureID() != GraphPackage.GPRE_RENDERED_ELEMENT__PARENT && newParent != null)) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GPRE_RENDERED_ELEMENT__PARENT, newParent, newParent));
   }
   ...
   public void setTrace(String newTrace) {
      ...
      trace = newTrace;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GPRE_RENDERED_ELEMENT__TRACE, oldTrace, trace));
   }
   ...
   public void setType(String newType) {
      ...
      type = newType;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GPRE_RENDERED_ELEMENT__TYPE, oldType, type));
   }
   ...
   public void setCode(String newCode) {
      ...
      code = newCode;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GPRE_RENDERED_ELEMENT__CODE, oldCode, code));
   }
