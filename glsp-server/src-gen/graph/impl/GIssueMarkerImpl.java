 ...
 * </p>
 * <ul>
 *   <li>{@link graph.impl.GIssueMarkerImpl#getId <em>Id</em>}</li>
 *   <li>{@link graph.impl.GIssueMarkerImpl#getCssClasses <em>Css Classes</em>}</li>
 *   <li>{@link graph.impl.GIssueMarkerImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link graph.impl.GIssueMarkerImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link graph.impl.GIssueMarkerImpl#getTrace <em>Trace</em>}</li>
 *   <li>{@link graph.impl.GIssueMarkerImpl#getType <em>Type</em>}</li>
 *   <li>{@link graph.impl.GIssueMarkerImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link graph.impl.GIssueMarkerImpl#getSize <em>Size</em>}</li>
 *   <li>{@link graph.impl.GIssueMarkerImpl#getIssues <em>Issues</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GIssueMarkerImpl extends GArgumentableImpl implements GIssueMarker {
   ...
   public EList<GModelElement> getChildren() {
      if (children == null) {
         children = new EObjectContainmentWithInverseEList<GModelElement>(GModelElement.class, this, GraphPackage.GISSUE_MARKER__CHILDREN, GraphPackage.GMODEL_ELEMENT__PARENT);
      }
      return children;
   }
   ...
   public GModelElement getParent() {
      if (eContainerFeatureID() != GraphPackage.GISSUE_MARKER__PARENT) return null;
   ...
   public void setParent(GModelElement newParent) {
      if (newParent != eInternalContainer() || (eContainerFeatureID() != GraphPackage.GISSUE_MARKER__PARENT && newParent != null)) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GISSUE_MARKER__PARENT, newParent, newParent));
   }
   ...
   public NotificationChain basicSetPosition(GPoint newPosition, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GraphPackage.GISSUE_MARKER__POSITION, oldPosition, newPosition);
   ...
   public void setPosition(GPoint newPosition) {
      if (newPosition != position) {
         NotificationChain msgs = null;
         if (position != null)
            msgs = ((InternalEObject)position).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GISSUE_MARKER__POSITION, null, msgs);
         if (newPosition != null)
            msgs = ((InternalEObject)newPosition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GISSUE_MARKER__POSITION, null, msgs);
         msgs = basicSetPosition(newPosition, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GISSUE_MARKER__POSITION, newPosition, newPosition));
   }
   ...
   public NotificationChain basicSetSize(GDimension newSize, NotificationChain msgs) {
      ...
      size = newSize;
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GraphPackage.GISSUE_MARKER__SIZE, oldSize, newSize);
         if (msgs == null) msgs = notification; else msgs.add(notification);
      }
      return msgs;
   }
   ...
   public void setSize(GDimension newSize) {
      if (newSize != size) {
         NotificationChain msgs = null;
         if (size != null)
            msgs = ((InternalEObject)size).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GISSUE_MARKER__SIZE, null, msgs);
         if (newSize != null)
            msgs = ((InternalEObject)newSize).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GraphPackage.GISSUE_MARKER__SIZE, null, msgs);
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
      if (baseClass == GBoundsAware.class) {
         switch (derivedFeatureID) {
            case GraphPackage.GISSUE_MARKER__POSITION: return GraphPackage.GBOUNDS_AWARE__POSITION;
            case GraphPackage.GISSUE_MARKER__SIZE: return GraphPackage.GBOUNDS_AWARE__SIZE;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
      if (baseClass == GBoundsAware.class) {
         switch (baseFeatureID) {
            case GraphPackage.GBOUNDS_AWARE__POSITION: return GraphPackage.GISSUE_MARKER__POSITION;
            case GraphPackage.GBOUNDS_AWARE__SIZE: return GraphPackage.GISSUE_MARKER__SIZE;
            default: return -1;
         }
      }
