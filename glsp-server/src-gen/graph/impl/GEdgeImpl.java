 ...
 * </p>
 * <ul>
 *   <li>{@link graph.impl.GEdgeImpl#getId <em>Id</em>}</li>
 *   <li>{@link graph.impl.GEdgeImpl#getCssClasses <em>Css Classes</em>}</li>
 *   <li>{@link graph.impl.GEdgeImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link graph.impl.GEdgeImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link graph.impl.GEdgeImpl#getTrace <em>Trace</em>}</li>
 *   <li>{@link graph.impl.GEdgeImpl#getType <em>Type</em>}</li>
 *   <li>{@link graph.impl.GEdgeImpl#getRoutingPoints <em>Routing Points</em>}</li>
 *   <li>{@link graph.impl.GEdgeImpl#getSourceId <em>Source Id</em>}</li>
 *   <li>{@link graph.impl.GEdgeImpl#getTargetId <em>Target Id</em>}</li>
 *   <li>{@link graph.impl.GEdgeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link graph.impl.GEdgeImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link graph.impl.GEdgeImpl#getRouterKind <em>Router Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GEdgeImpl extends GArgumentableImpl implements GEdge {
   ...
   public EList<GModelElement> getChildren() {
      if (children == null) {
         children = new EObjectContainmentWithInverseEList<GModelElement>(GModelElement.class, this, GraphPackage.GEDGE__CHILDREN, GraphPackage.GMODEL_ELEMENT__PARENT);
      }
      return children;
   }
   ...
   public GModelElement getParent() {
      if (eContainerFeatureID() != GraphPackage.GEDGE__PARENT) return null;
   ...
   public void setParent(GModelElement newParent) {
      if (newParent != eInternalContainer() || (eContainerFeatureID() != GraphPackage.GEDGE__PARENT && newParent != null)) {
   ...
   public void setRouterKind(String newRouterKind) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GEDGE__ROUTER_KIND, oldRouterKind, routerKind));
   }
