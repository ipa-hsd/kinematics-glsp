 ...
 *   <li>{@link kinematics.impl.LinkImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinkImpl extends MinimalEObjectImpl.Container implements Link {
   ...
   public void setId(String newId) {
      ...
      id = newId;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, KinematicsPackage.LINK__ID, oldId, id));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case KinematicsPackage.LINK__NAME:
            return getName();
         case KinematicsPackage.LINK__ID:
            return getId();
      }
